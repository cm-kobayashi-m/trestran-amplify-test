...
const L1PromptPage = () => {
  ...
  const [promptContent, setPromptContent] = useState(
    "あなたは経験豊富なビジネスコンサルタントです。顧客の課題を深く理解し、最適なソリューションを提案してください。",
  )
  ...
  const handleConfirmSave = () => {
    try {
      console.log("Saving L1 prompt:", promptContent)
      // TODO: API call to save prompt

      toast({
        title: "成功",
        description: "L1プロンプトを保存しました",
      })
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <main className="flex-1 ml-64 flex flex-col">
        <Header title="L1: 思考OSプロンプト" subtitle="グループ全体の思考フレームワークを定義" />
      ...
      <AlertDialog open={showConfirmDialog} onOpenChange={setShowConfirmDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>L1プロンプトを保存しますか？</AlertDialogTitle>
            <AlertDialogDescription>変更内容を保存すると、グループ全体に適用されます。</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
